...
#simply typing 'make' will compile all source code files to object files .o, andthen link all
...
$(PROGRAM_NAME): FinalProject.o Plant.o Character.o Weather.o
	$(CC) -o $@ $^ $(CFLAGS) $(LDFLAGS)

clean:
	$(RM) *.o $(PROGRAM_NAME)$(EXEEXT)# Linux (default)
